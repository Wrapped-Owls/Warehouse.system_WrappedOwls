			...
			<div class="container-contact100">
				...
				<div class="wrap-contact100">
                    ...
                    Cadastrar produto
						...
						<div class="wrap-input100 validate-input" data-validate="Name is required">
							<input id="name" type="text"
								   ...
								   name="name" value="{{ old('name') }}" required autofocus placeholder="Nome do produto">
                    ...
                    <textarea id="material_description"
							  ...
							  required placeholder="Descrição"></textarea>
						...
						<div class="wrap-input100 validate-input" data-validate="Name is required">
							<input id="price" type="number" step="0.01"
								   ...
								   name="price" value="{{ old('price') }}" required autofocus placeholder="Preço (R$)">
