                    ...
                    <form class="contact100-form validate-form" enctype="multipart/form-data" method="POST"
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Name is required">
                            <input id="name" type="text" class="input100{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                   name="name" placeholder="{{ $data['name']}}" autofocus>
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Message is required">
                            <textarea id="material_description"
                                      ...
                                      name="material_description" placeholder="{{ $data['description']}}"></textarea>
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Name is required">
                            <input id="price" type="number"
                                   class="input100{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price"
