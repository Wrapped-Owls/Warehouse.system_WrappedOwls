            ...
            <form class="contact100-form validate-form" action="{{ route('register') }}" method="post">
                ...
                <div class="wrap-input100 validate-input" data-validate="Name is required">
                    <input id="name" type="text" class="input100{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                name="name"
                                value="{{ old('name') }}" required autofocus placeholder="Nome completo">
                ...
                <label for="product_image" class="input100"><h5>Nível de acesso</h5></label>
                
                <div class="contact100-form-checkbox">
                    <table>
                                    <tr><td><input id="accessLevel" type="radio" class="form-group" name="accessLevel" value="0"> 1 - Colaborador</td></tr>
                                    <tr><td><input id="accessLevel" type="radio" class="form-group" name="accessLevel" value="1"> 2 - Docente Coordenador</td></tr>
                                    <tr><td><input id="accessLevel" type="radio" class="form-group" name="accessLevel" value="3"> 3 - Administrador SGDA</td></tr><br>
                                </table>
                                @if(isset($data))
                                    <br><label for="area">{{ __('Área de atuação') }}</label>
