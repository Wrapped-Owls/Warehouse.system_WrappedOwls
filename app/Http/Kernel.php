...
use App\Http\Middleware\Warehouse\Admin;
use App\Http\Middleware\Warehouse\Collaborator;
...
class Kernel extends HttpKernel {
	...
	protected $middleware = [// \App\Http\Middleware\TrustHosts::class,
	                         TrustProxies::class, HandleCors::class, PreventRequestsDuringMaintenance::class,
	                         ValidatePostSize::class, TrimStrings::class, ConvertEmptyStringsToNull::class,
	];
	...
	protected $routeMiddleware = [
		...
		'verified'         => EnsureEmailIsVerified::class, 'admin' => Admin::class,
